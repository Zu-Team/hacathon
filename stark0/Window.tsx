...
export const Window: React.FC<WindowProps> = ({
  ...
  return (
    <div className="w-[800px] h-[600px] bg-white border border-gray-300 rounded-xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex flex-col relative overflow-hidden font-sans backdrop-blur-sm bg-white/80">
      {/* Title Bar */}
      <div className="bg-gradient-to-b from-gray-800 to-gray-700 text-white py-2 px-4 font-semibold text-base flex justify-between items-center select-none cursor-default rounded-t-xl flex-shrink-0">
